...
from openlineage.client.facet import ExpectationAssertion, ExpectationsAssertionsDatasetFacet
...
class DbtArtifactProcessor:
    ...
    def parse_test(
        ...
        for run in run_results['results']:
            ...
            assertions[model_node].append(ExpectationAssertion(
                expectationType=test_node['test_metadata']['name'],
        ...
        for name, node in manifest['nodes'].items():
            ...
            assertion_facet = ExpectationsAssertionsDatasetFacet(
            ...
            completes.append(RunEvent(
                ...
                inputs=[Dataset(namespace, name, facets={
                    "expectationsAssertions": assertion_facet
                })],
                outputs=[]
            ))
